...
<div class="container container-conta">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <p>Atualize as informações da sua conta pelo <a href="{{config("app.pacoca_url")}}/conta" target="_blank" rel="noopener noreferrer">Central de Contas</a> Alterações são refletidas no Paçoca, RITA e ReadBooks!    </p>
